...
# Parsing + Configuration Script – TRB245 - Rev. A

This **Parsing + Configuration** script is designed for the **TRB245** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – TRB245 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **TRB245** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
